...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-5" aria-hidden="true">
      ...
      <path
        fill="#EA4335"
        d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.26 6.61l4.01 3.1C6.22 6.86 8.87 4.75 12 4.75Z"
      />
    </svg>
  )
}
...
export function GoogleButton({ onClick }: { onClick?: () => void }) {
  return (
    <Button
      ...
      variant="outline"
      onClick={onClick}
      className="h-12 w-full gap-3 rounded-xl border-border text-sm font-medium"
    >
      <GoogleIcon />
