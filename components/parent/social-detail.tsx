        ...
        <div className="flex flex-col gap-5">
          ...
          {feedPosts.length ? (
            feedPosts.map((post) => {
              ...
              return <div key={post.id} className={focusedId === post.id ? "rounded-2xl ring-4 ring-brand/35 ring-offset-4 ring-offset-lavender transition-all" : "transition-all"}><PostCard post={post} onHide={onHide} onDelete={onDelete} serverBacked={isServer} readOnly={!hasFullAccess} /></div>
            })
          ) : (
