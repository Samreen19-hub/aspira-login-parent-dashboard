...
import { getSocialSpace } from "@/lib/parent-data"

/** Resolve where a saved post should open, based on its original source (scope). */
function destinationFor(scope?: string) {
  if (!scope) return "/parent"
  const space = getSocialSpace(scope)
